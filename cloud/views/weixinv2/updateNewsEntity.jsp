...
<body class="nav-md">
	<div class="container body">
		<div class="main_container">
				...
				<div class="x_panel">
					<div class="x_title">
						<h4 class="modal-title">新增图文消息</h4>
					</div>
					<div class="x_content">
				<form id="demo-form2" data-parsley-validate
												class="form-horizontal form-label-left"
												action="/cloud/weixinv2/updateNewsAction" method="POST">
												<div class="form-group">								
								<input name="newId" value=${newId }
									style="display: none">
							</div>
						...
						<div class="col-md-8 col-sm-4 col-xs-12">
							<div class="x_content">
								<div class="newcontentpart">
									<h4>标题</h4>
									<input class="title form-control " id="title_0" name="title" value="${one.title }">
								</div>
								<div class="newcontentpart">
									<h4>作者</h4>							
									<input class="description form-control " id="description_0" name="author" value="${one.author }">
								</div>
								<div class="newcontentpart">
									<h4>封面</h4>
                                ...
                                <div id="editor" name="content" value="${one.content }">                               
