...
<body>
	...
	<div id="page"
		style="border-style: dashed; border-color: red; line-height: 30px; background: url(sorry.png) no-repeat right;">
		<h1>抱歉，我们的页面出现了异常~</h1>
		<h2>Sorry, the page you requested was not ready</h2>
		<font color="#666666">你请求访问的页面发生异常, 请稍后再试！</font>
		<br />
		<br />
		...
		<div class="button">
			<a href="/cloud" title="返回云平台">返回云平台</a>
		</div>
	</div>
