...
function resizeHeight() {
    ...
    if (h > window.innerHeight) {
        $(".right_col,.left_col,.main_container,.container,body").css("height", "auto");
    }
    else {
        $(".right_col,.left_col,.main_container,.container,body").css("height", "100%");
    }
    /*    var screenHeight = window.innerHeight;
        var h = document.body.scrollHeight;
        if ($('.right_col').height() < screenHeight) {
