							...
							if (f.fileType) {
								...
								if (b.isArray(f.fileType)) {
									...
									for (var l = 0; l < f.fileType.length; l++) {
										// k为待上传文件信息
										// k=File {webkitRelativePath: "",
										// lastModified: 1415932610000,
										// lastModifiedDate: Fri Nov 14 2014
										// 10:36:50 GMT+0800 (中国标准时间), name:
										// "功能结构.PNG", type: "image/png"…}
