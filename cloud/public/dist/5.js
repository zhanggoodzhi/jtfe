...
var StatisticsGoodCommentIndex;
(function (StatisticsGoodCommentIndex) {
    var pieChart;
    var lineChart;
    var datePicker;
    var goodTable;
    ...
    function initTable() {
        goodTable = new new_table_1.Table({
            el: $('#good-table'),
            options: {
                paging: true,
                scrollY: '300px',
                ...
                initComplete: function () {
                    ...
                    $('#export').on('click', function () {
                        var href = "spss/feedbackRate/exportCategoryFeedbackExcel?" + $.param({
                            mode: datePicker.mode,
                            startDay: datePicker.date.startDay,
                            endDay: datePicker.date.endDay
                        });
                ...
                columns: [
                    ...
                    { data: 'appraiseRate', title: '参评率<i class="table-tip fa fa-question-circle" id="percent-tip"></i>', orderable: false, render: utils_1.renderPercent },
                    { data: 'goodNum', title: '好评数', orderable: false },
                    { data: 'goodRate', width: '30', title: '好评率', render: utils_1.renderPercent },
                    { data: 'badNum', title: '差评数', orderable: false },
                    { data: 'badRate', width: '30', title: '差评率', render: utils_1.renderPercent }
                ]
            }
        });
    }
...
})(StatisticsGoodCommentIndex || (StatisticsGoodCommentIndex = {}));
