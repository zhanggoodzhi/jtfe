...
__webpack_require__(20)(__webpack_require__(295))
...
(function (ResetPwdIndex) {
    ...
    function next() {
        var index;
        var bigEl = $('.reset-container');
        var circleArr = $('.wizard_steps').find('a').toArray();
        circleArr.forEach(function (v) {
            var el = $(v);
        ...
        circleArr.forEach(function (v, i) {
            var el = $(v);
            if (i + 1 < nextIndex) {
