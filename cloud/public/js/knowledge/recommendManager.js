...
var recommendManager = (function($,undefined){
	...
	var queryUrl = "queryRecommends";
	var editUrl = "editRecommend";
	var deleteUrl = "deleteRecommend";
	...
	var addRecommend = function(){
		editCorpusDialogConfig.title = "添加推荐问题";
	...
	var initGrid = function(){
		gridManager = $("#recommendGrid").ligerGrid({
//			width : '100%',
//			height : 'auto',
//			nowrap : true,
//			striped : true,
//			fitColumns : false,
			columns:[{
				...
				render: function (rowdata, rowindex, value){
	            	var h = "";
	            	if (!rowdata._editing){
		                h += "<a href='javascript:recommendManager.deleteCorpusClick(" + rowindex + ")'>删除</a> "; 
	            	}
	            	return h;
	            }
	        }],
