...
interface RectificationNoticeUpdateProps extends CommomComponentProps<RectificationNoticeUpdateProps> {
};

interface RectificationNoticeUpdateState {
  number: number;
};

class RectificationNoticeUpdate extends React.Component<RectificationNoticeUpdateProps, RectificationNoticeUpdateState> {
  private edit;
  private oldHtml;
    ...
    return (
      <div className={style.Detail}>
        ...
        <div className={style.StatusWrap}>
          <h5>状态：未办结</h5>
          <Button onClick={this.submit} className={style.Submit} type="primary">回复</Button>
...
export default connect<any, any, RectificationNoticeUpdateProps>(
  null, null
)(RectificationNoticeUpdate) as any;
