...
interface PrepackageFoodProps extends CommomComponentProps<PrepackageFoodProps> {
  push?: Redux.ActionCreator<RouterAction>;
  form;
};
interface PrepackageFoodState { };

class PrepackageFood extends React.Component<PrepackageFoodProps, PrepackageFoodState> {
  ...
  public render(): JSX.Element {
    ...
    const dataSource = [
      { id: 1, photo: '', name: '酱油', type: '调味品', brand: '海天', spec: '500ml/瓶', date1: '2017-06-19', amount: '10', business: 'xxx公司', date2: '2017-06-19' },
      { id: 2, photo: '', name: '酱油', type: '调味品', brand: '海天', spec: '500ml/瓶', date1: '2017-06-19', amount: '10', business: 'xxx公司', date2: '2017-06-19' }
    ];
    return (
...
const PrepackageFoodForm = Form.create()(PrepackageFood);
export default connect<any, any, PrepackageFoodProps>(
  (state) => ({
    // Map state to props
  }),
  dispatch => ({
