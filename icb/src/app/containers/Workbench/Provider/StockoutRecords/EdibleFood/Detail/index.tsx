...
interface EdibleFoodDetailProps extends CommomComponentProps<EdibleFoodDetailProps>, FormComponentProps { };

interface EdibleFoodDetailState { };

class EdibleFoodDetail extends React.Component<EdibleFoodDetailProps, EdibleFoodDetailState> {
...
export default connect<any, any, EdibleFoodDetailProps>(
  (state) => ({
    // Map state to props
  }),
  {
    // Map dispatch to props
  })(Form.create()(EdibleFoodDetail));
