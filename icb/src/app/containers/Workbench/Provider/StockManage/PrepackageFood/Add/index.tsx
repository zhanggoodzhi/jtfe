...
interface StockPreAddProps extends CommomComponentProps<StockPreAddProps>, FormComponentProps { };

interface StockPreAddState { };

class StockPreAdd extends React.Component<StockPreAddProps, StockPreAddState> {
