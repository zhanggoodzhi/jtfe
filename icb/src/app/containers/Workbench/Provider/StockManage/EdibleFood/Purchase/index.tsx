...
interface StockEdiblePurchaseProps extends CommomComponentProps<StockEdiblePurchaseProps>, FormComponentProps { };

interface StockEdiblePurchaseState { };

class StockEdiblePurchase extends React.Component<StockEdiblePurchaseProps, StockEdiblePurchaseState> {
...
export default connect(
  ...
  })(Form.create()(StockEdiblePurchase));
