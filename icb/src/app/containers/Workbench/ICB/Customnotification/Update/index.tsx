...
interface CustomnotificationUpdateProps extends CommomComponentProps<CustomnotificationUpdateProps> {
};

interface CustomnotificationUpdateState {
  number: number;
};

class CustomnotificationUpdate extends React.Component<CustomnotificationUpdateProps, CustomnotificationUpdateState> {
  private edit;
  private oldHtml;
    ...
    return (
      <div>
        <div className={style.StatusWrap}>
          <h5>状态：未办结</h5>
          <Button onClick={this.solve} className={style.Solve} type="primary">办结</Button>
...
export default connect<any, any, CustomnotificationUpdateProps>(
  null, null
)(CustomnotificationUpdate) as any;
