...
interface CustomnotificationDetailProps extends CommomComponentProps<CustomnotificationDetailProps> {
};

interface CustomnotificationDetailState {
  number: number;
};

class CustomnotificationDetail extends React.Component<CustomnotificationDetailProps, CustomnotificationDetailState> {
  private edit;
  private oldHtml;
...
export default connect<any, any, CustomnotificationDetailProps>(
  null, null
)(CustomnotificationDetail) as any;
