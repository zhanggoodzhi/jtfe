  ...
  public render(): JSX.Element {
    ...
    return (
      <div className={style.Detail}>
        ...
        <Switch>
          <Route path="/home/canteen/rectification/self" component={RectificationSelf} exact />
          <Route path="/home/canteen/rectification/notice" component={RectificationNotice} exact />
          <Redirect to="/home/canteen/rectification/self" />
        </Switch>
      </div >
    );
  }
