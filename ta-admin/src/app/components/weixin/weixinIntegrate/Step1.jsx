    ...
    render() {
        ...
        return (
            <div className="weixinIntegrate-wrap">
                ...
                <Row className="mt"><img style={{ width: '100%', height: 'auto' }} src="/resources/image/weixinIntegrate/1.jpg" /></Row>
                <Row className="btn-wrap mt" style={{ textAlign: 'center' }}>
                    <Button size="large" type="primary" onClick={() => { this.context.router.push('/workbench/weixin/integrate/step2') } }>下一步</Button>
