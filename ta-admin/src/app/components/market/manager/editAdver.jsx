...
class EditAdver extends React.Component{
    constructor(props){
        super(props);
        this.state={
            ...
            <div>
                <Form layout="vertical">
                    ...
                    <Row type="flex" align="middle" justify="start">
                        <Col sm={24} xs={24} md={7} lg={7}>
                            <FormItem label="选择触发事件类型">
                                {getFieldDecorator('type', { initialValue: 'noop' })(
                    ...
                    <Row type="flex" align="middle" justify="start">
                        <Col sm={24} xs={24} md={7} lg={7}>
                            <FormItem label="横幅名称">
                                {getFieldDecorator('bannerName', { initialValue: '冲10送1' })(
                                    <Input type="text"/>
                                )}
                            </FormItem>
                        </Col>
                        ...
                        <Col sm={24} xs={24} md={8} lg={20}>
                            <FormItem label="横幅图片">
                                {getFieldDecorator('bannerPic')(
                                    <img src='' width='600px' height='200' alt='横幅图片'/>
                                )}
                            </FormItem>
                        </Col>
                    </Row>
...
const EditAdverForm=Form.create({})(EditAdver);
export default EditAdverForm;